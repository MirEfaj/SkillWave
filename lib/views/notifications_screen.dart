  ...
  Widget _buildNotificationTile(Map<String, dynamic> notification, int index) {
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(notification['title'], style: TextStyle(fontWeight: notification['read'] ? FontWeight.w500 : FontWeight.bold, color: Colors.black87,),),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [Text(notification['message'], style: TextStyle(color: Colors.grey[600]),),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text("No notifications yet", style: TextStyle(fontSize: 18, color: Colors.white),),
          const SizedBox(height: 8),
          Text("You're all caught up!", style: TextStyle(fontSize: 14, color: Colors.white.withAlpha(150)),),
        ],
      ),
    );
  }
