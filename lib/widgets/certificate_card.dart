    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text("Grade: $grade", style:  TextStyle(color: IconColor, fontWeight: FontWeight.bold,),),
              ),
            ],
          ),
          ...
          Text("Certificate ID: $certificateId", style: const TextStyle(fontSize: 12, color: Colors.black54)),
        ],
      ),
    );
  }
