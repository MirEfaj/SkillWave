...
// import '../services/course_progress_service.dart'; // NEW
//
...
//                         subtitle: Text(widget.lectureTitle[index], maxLines: 1, overflow: TextOverflow.ellipsis),
...
//           const SizedBox(height: 12),
//           Row(children: [
//             Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: Colors.indigo.shade50, borderRadius: BorderRadius.circular(8)), child: const Icon(Icons.book, color: Colors.indigo)),
//             const SizedBox(width: 12),
